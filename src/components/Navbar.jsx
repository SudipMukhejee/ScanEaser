...
const Navbar = () => {
  ...
  return (
    <nav className="w-[80%] mx-auto flex flex-col items-center mt-5">
      <div className="flex justify-between pt-5 pb-8 items-center lg:border-b-2 border-b-white/30 w-full duration-300 ">
        ...
        <button className="flex bg-green-600 py-4 px-6 text-center text-white font-bold rounded-3xl  items-center uppercase">
          ...
          <span className="rounded-full bg-green-600">
            <svg
              fill="none"
              viewBox="0 0 20 20"
              className="h-[20px] ml-[10px] bg-green-600 rounded-full animate-bounce"
            >
              <path
                fill="#fff"
