...
const CardSection = () => {
  ...
  return (
    <div 
      className=" 
        grid p-5 w-80vw rounded-md h-auto md:grid-cols-2 md:gap-x-6 lg:grid-cols-3 lg:gap-x-10 gap-y-6 content-evenly justify-center justify-items-center bg-[#DAE0E2] ">
